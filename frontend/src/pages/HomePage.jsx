        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Create Meeting</h2>
          ...
          <Link 
            to="/join"
            className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-green-300"
          >
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Join Meeting</h2>
              <p className="text-gray-600 mb-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Facilitator creates a meeting, participants join with a code</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-600 text-white w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                2
              ...
              <p className="text-gray-600">No accounts needed - just enter your name to participate</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-600 text-white w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                3
              </div>
              <h3 className="text-xl font-semibold mb-2">Speaking Queue</h3>
              <p className="text-gray-600">Raise your hand to speak or make direct responses</p>
            </div>
          </div>
        </div>
      </div>
